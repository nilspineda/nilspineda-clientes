  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2 flex-wrap">
        <button
          onClick={exportCSV}
          className="px-4 py-2 rounded-xl bg-muted border border-border text-muted-foreground hover:text-foreground hover:bg-accent text-sm transition-all"
        >
          Exportar CSV
        </button>
        <button
          onClick={() => setShowModal(true)}
          className="px-4 py-2 rounded-xl bg-primary text-foreground hover:bg-primary-light text-sm font-medium transition-all"
        >
          Registrar Pago
        </button>
      </div>
