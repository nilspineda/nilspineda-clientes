    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div
            className={`text-center mb-8 hidden lg:block transition-all duration-1000 delay-200 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
          ...
          <div
            className={`text-center mt-8 transition-all duration-1000 delay-500 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
